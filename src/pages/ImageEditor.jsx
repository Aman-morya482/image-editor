...
const handleInputBlur = () => {
  ...
  const [opneformat,setOpenFormat] = useState(false);
    ...
    <nav className="bg-slate-700 text-white px-3 py-3 md:px-6 md:py-4 flex justify-between items-center">
      <ul className="w-full flex space-x-4 justify-between items-center">
        ...
        <div className="flex gap-10">
          <button className="bg-red-500 py-2 px-3 rounded-md hidden md:block" onClick={()=>handleClearAll()}>Clear All</button>
          <div className="flex justify-center">
          <label className="bg-green-500 py-2 px-3 rounded-md hidden md:block" onChange={(e)=>handleImageChange(e)}>Change File
          <input type="file" accept="image/*" className="hidden" ></input>
          </label>
          </div>
        </div>
        <div className="relative flex gap-2 md:gap-12 font-bold">
        <li className="flex items-center border-2 border-black bg-yellow-400 text-sm md:text-lg px-2 md:px-1 py-1 rounded-md text-black"><a href="#crop" onClick={downloadImage}  className="border-r px-2 py-1 border-black hover:text-white">Download</a><span className="px-2 py-1 hover:text-white" onClick={()=>{setOpenFormat(!opneformat)}}><FaAngleDown/></span></li>
        <div className={`absolute right-0 top-12 w-[100px] ${opneformat ? 'opacity-100' : 'opacity-0'}`}>
    ...
    return nextRotation;
        ...
        <div className={`md:h-[500px] w-full md:w-[400px] bg-white absolute shadow-lg border-t-2 border-gray-400 rounded-t-xl md:rounded-lg px-3 md:px-6 py-3 md:py-6 left-0 md:top-5 overflow-x-scroll md:overflow-x-hidden ${togFilter ? "-top-36 md:left-22" : "top-50 md:-left-120"}`}>
          <ul className="flex gap-6 md:flex-wrap ">
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={()=>{updateFilter({brightness:110,constrast:80,saturation:120})}}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px]"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Original</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={()=>{updateFilter({brightness:100,constrast:120,saturation:140})}}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] brightness-100 contrast-120 saturate-140"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Vivid</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={()=>{updateFilter({brightness:100,constrast:140,saturation:110})}}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] brightness-100 contrast-140 saturate-110"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Pixi 1</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={()=>{updateFilter({brightness:110,constrast:130,saturation:140, sepia:50})}}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] brightness-110 contrast-130 saturate-140 sepia-50"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Pixi 2</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ grayscale: 100 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] grayscale-100"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">B&W</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ grayscale: 50 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] grayscale-50"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Grayscale</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ sepia: 80, contrast: 110, brightness: 90 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] sepia-80 contrast-110 brightness-90"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Vintage</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ hue: 180, contrast: 110, saturation: 120 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] hue-rotate-180 contrast-110 saturate-120"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Cool Tone</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ blur: 3, opacity: 70 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] blue-[2px] opacity-70"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Dreamy</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ brightness: 120, contrast: 110, blur: 2 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] brightness-120 contrast-110 blur-[1px]"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Soft Glow</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ hue: -20, contrast: 120, saturation: 140 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] -hue-rotate-20 contrast-120 saturate-140"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Warm Tone</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ contrast: 200, brightness: 80, saturation: 150 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] contrast-200 brightness-80 saturate-150"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Cinematic</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ invert: 100 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] invert-100"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Invert</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ brightness: 80, saturation: 50, sepia: 60 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] brightness-80 saturate-50 sepia-180 "></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Retro</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ contrast: 130, invert: 20, hue: 180 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:w-[140px] md:h-[140px] contrast-130 invert-20 hue-rotate-180"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Cyberpunk</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ brightness: 110, sepia: 30, hue: 30, saturation: 140 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:h-[140px] md:w-[140px] brightness-110 sepia-30 hue-rotate-30 saturate-140"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Golden</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ hue: 90, brightness: 105, saturation: 160 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:h-[140px] md:w-[140px] hue-rotate-90 brightness-105 saturate-160"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Toxic Green</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ hue: 90, brightness: 130, contrast: 80 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:h-[140px] md:w-[140px] hue-rotate-90 brightness-120 contrast-80"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">Night Vision</p></li>
            <li className="border-2 border-gray-400 bg-purple-200 md:p-1 rounded-md min-w-[90px] p-1 hover:ring-2 ring-blue-300 active:bg-gray-300" onClick={() => updateFilter({ invert: 100, brightness: 140, saturation: 30 })}><img src={ogImage} className="object-center overflow-hidden h-[80px] w-[80px] md:h-[140px] md:w-[140px] invert brightness-140 saturate-30"></img><p className="text-center tracking-wider text-sm md:pt-[3px]">X-Ray</p></li>
          </ul>
        </div>
        ...
        <p className="flex gap-4 items-center">Color:<input type="color" className="w-full h-[40px] cursor-pointer" value={color} onChange={(e) => updateTextProperties("color", e.target.value)} /></p>
        <p className="flex gap-2 items-center">Size:<span>{fontSize}px</span><input type="range" min="10" max="100" step="2" value={fontSize} onChange={(e) => { const newSize = parseInt(e.target.value, 10); setFontSize(newSize); updateTextProperties("size", newSize);}} />
        </p>
