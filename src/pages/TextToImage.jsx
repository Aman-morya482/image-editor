  ...
  return (
    <div className='gird grid-cols-1 place-items-center relative'>
      <div className={`${!image ? "min-h-screen" : "min-h-[50vh] xl:min-h-[30vh] md:mt-20"} ${loading ? "md:mt-20" : ""} flex flex-col items-center justify-center gap-4 px-2 md:px-10`}>
        <img src="/img/artificial-intelligence.gif" alt="animated-svg" className={`w-[120px] absolute ${image || loading ? "-top-10" : "top-7"} right-7 hidden md:block`} />
        ...
        <div className='flex flex-wrap justify-center items-center gap-2'>
          ...
          <button onClick={sendToBackend} ref={buttonRef} disabled={loading} className={`p-3 bg-gradient-to-r from-blue-600 via-purple-800 to-red-500 rounded-md text-white ring-blue-300 active:scale-95 hover:ring-2 cursor-pointer flex gap-2 items-center`}><PiMagicWandDuotone size={24} />{loading ? "Processing..." : "Generate Image"}</button>
        </div>
        {!image && !loading && (
