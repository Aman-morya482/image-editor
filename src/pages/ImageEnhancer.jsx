...
img.src = image;
  ...
  return (
   ...
   <div className="relative max-w-[1800px] w-full min-h-[92vh] bg-rose-200 flex flex-col justify-center items-center">
     <span className='hidden md:block'><img src="/png/014-filter.png" alt="" width={130} className='absolute top-20 right-60 float-svg'/></span>
     <span className='hidden md:block'><img src="/png/025-ai-art.png" alt="" width={110} className='absolute bottom-40 left-50 scale-svg'/></span>
      ...
      <h3 className="mb-8 text-rose-600 text-center px-2 font-semibold text-lg">Transform low-quality images into crisp, vibrant ones.</h3>
          ...
          <div className="group flex flex-col items-center justify-center">
            <label className="bg-rose-500 text-white md:font-bold w-xs md:w-2xl ring-red-300 hover:ring-3 text-lg md:text-xl rounded-full py-3 md:p-5 text-center cursor-pointer active:scale-95">
              Upload Image
...

    {
      !enhancedImage && image && (
        ...
        <div className='relative flex justify-between w-4/5'>
          ...
          <button className='flex items-center bg-rose-500 ring-red-300 hover:ring-3 active:scale-95 rounded-md py-2 text-white cursor-pointer'><p onClick={()=>makeEnhanced()} className='border-r px-2'>{!loading ? "Enhance Now" : "Processing..." }</p></button>
