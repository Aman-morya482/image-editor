      ...
      <div className='relative flex justify-around items-center h-screen w-full max-w-[1800px] z-10 bg-cyan-200 overflow-hidden'>
        ...
        <div className='w-full flex flex-col justify-between items-center py-10 md:pl-20 overflow-hidden'>
          <div className='flex flex-col justify-center items-center'>
            <h1 className='text-4xl md:text-6xl font-bold leading-[50px] md:leading-[70px] text-center'>The Online <br className='md:hidden'/> <span className='text-blue-700'>image Editor</span> <br />Made for Everyone</h1>
            <label className='w-xs md:w-xl py-3 md:py-4 px-5 mt-6 text-center text-2xl active:scale-95 hover:ring-3 ring-blue-400 bg-blue-600 text-white rounded-full font-semibold tracking-wider'>
              Start Editing
          ...
          <div className='w-full md:w-5xl flex flex-wrap justify-center p-10 gap-x-8 gap-y-4 mt-2'>
            <div className='flex items-center justify-center w-2xs gap-2 border-2 border-white rounded-md bg-white/30 hover:bg-white/50 py-4 px-6 text-lg text-indigo-600 font-semibold'>
