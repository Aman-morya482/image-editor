...
const DraftConfirm = ({cancel}) => {
  ...
  return (
    <div className='absolute left-0 top-0 z-100 w-full h-screen bg-black/50  flex justify-center items-center font-normal'>
      <div className='relative py-8 px-6 flex flex-col justify-start w-[350px] h-[180px] bg-white border shadow-2xl rounded-xl'>
        ...
        <p className='text-sm'>Are you sure you want to discard editing?</p>
