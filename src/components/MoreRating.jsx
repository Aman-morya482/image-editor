...
const MoreRating = () => {
    ...
    return (
        <div className='relative w-full max-w-[1800px] text-white bg-gradient-to-bl from-black/60 via-black/80 to-black p-10 md:p-16'>
            <p className='text-center text-4xl font-bold mb-12'>Our User's Rating !!</p>
            <div className='w-full flex justify-center '>
                <button onClick={() => setOpenRating(true)} className='bg-white/90 hover:bg-white text-black px-14 py-3 rounded-full text-xl font-semibold cursor-pointer ring-white/40 hover:ring-3'>{`Add Your Review >`}</button>
            </div>
            <div className='flex flex-wrap justify-center gap-x-10 gap-y-14 px-14 mt-10'>
